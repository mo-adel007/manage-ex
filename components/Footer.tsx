          ...
          <div className="contact-section">
            ...
            <div className="contact-grid">
                ...
                <div className="contact-details">
                  <div className="contact-item">
                    ...
                    <div className="contact-info">
                      ...
                      <a href="tel:+966530942000" className="contact-value">+966 53 094 2000</a>
                    </div>
                  </div>
                  ...
                  <div className="contact-item">
                    ...
                    <div className="contact-info">
                      ...
                      <div className="whatsapp-numbers">
                        <a href="https://wa.me/966532402275" className="contact-value">+966 53 240 2275</a>
                        <a href="https://wa.me/966505154013" className="contact-value">+966 50 515 4013</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="contact-item">
                    ...
                    <div className="contact-info">
                      ...
                      <a href="mailto:Hi@ManageEx.com" className="contact-value">Hi@ManageEx.com</a>
                    </div>
                  </div>
                  ...
                  <div className="contact-item">
                    ...
                    <div className="contact-info">
                      ...
                      <p className="contact-value">
                        Saudi Arabia - Riyadh - Al Aziziyah District<br />
                        المملكة العربية السعودية - الرياض - حي العزيزية
                      </p>
                    </div>
                  </div>
              ...
              <div className="contact-card egypt-office">
                ...
                <div className="contact-details">
                  <div className="contact-item">
                    ...
                    <div className="contact-info">
                      <span className="contact-label">{t('footer.call')}</span>
                      <a href="tel:+201150038400" className="contact-value">(+02) 1150038400</a>
                    </div>
                  </div>
                  ...
                  <div className="contact-item">
                    ...
                    <div className="contact-info">
                      <span className="contact-label">{t('footer.location')}</span>
                      <p className="contact-value">
                        Cairo Capital Center, Banks Complex<br />
                        90th Street - 5th Settlement<br />
                        مبنى كايرو كابيتال سنتر - مجمع البنوك<br />
              ...
              <div className="map-section">
                <h4 className="map-title">Saudi Location</h4>
